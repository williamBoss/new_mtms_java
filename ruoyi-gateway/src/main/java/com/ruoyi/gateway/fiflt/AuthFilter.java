...
public class AuthFilter implements GlobalFilter, Ordered {
    ...
    private static final String[] whiteList =
        {"/auth/login", "/user/register", "/system/v2/api-docs", "/auth/v2/api-docs", "/dfs/v2/api-docs",
            "/mtms/v2/api-docs"};
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        String userStr = stringRedisTemplate.opsForValue().get(Constants.ACCESS_TOKEN + token);
