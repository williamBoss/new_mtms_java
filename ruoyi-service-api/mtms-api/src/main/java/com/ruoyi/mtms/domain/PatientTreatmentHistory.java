...
public class PatientTreatmentHistory {
    ...
    public static final String COL_CONSULTATION_DATE = "consultation_date";

    public static final String COL_EMERGENCY_INFUSION_NUM = "emergency_infusion_num";

    public static final String COL_HOSPITALIZATION_NUM = "hospitalization_num";

    public static final String COL_PHYSICIAN = "physician";
